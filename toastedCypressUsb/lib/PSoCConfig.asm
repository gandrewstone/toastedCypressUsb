...
export LoadConfig_toastedlightuinousb4
export _LoadConfig_toastedlightuinousb4
export UnloadConfig_toastedlightuinousb4
export _UnloadConfig_toastedlightuinousb4
export ReloadConfig_toastedlightuinousb4
export _ReloadConfig_toastedlightuinousb4
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_Data_SHADE], 2h

	lcall	LoadConfig_toastedlightuinousb4
	lcall	LoadConfigTBL_toastedlightuinousb4_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration toastedlightuinousb4
;
;    Load configuration registers for toastedlightuinousb4.
...
;               CUR_PP
;
_LoadConfig_toastedlightuinousb4:
 LoadConfig_toastedlightuinousb4:
    RAM_PROLOGUE RAM_USE_CLASS_4
	M8C_SetBank0
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_toastedlightuinousb4_Bank0
    mov     X, <LoadConfigTBL_toastedlightuinousb4_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_toastedlightuinousb4_Bank1
    mov     X, <LoadConfigTBL_toastedlightuinousb4_Bank1
    lcall   LoadConfig              ; Load the bank 1 values

	RAM_SETPAGE_CUR >ACTIVE_CONFIG_STATUS
; set config active bit
	or		[ACTIVE_CONFIG_STATUS+toastedlightuinousb4_ADDR_OFF], toastedlightuinousb4_BIT
...
;---------------------------------------------------------------------------
; Reload Configuration toastedlightuinousb4
;
;    Reload configuration registers for toastedlightuinousb4.
;    IO Bank 0 registers a loaded first,then those in IO Bank 1.
;
;       INPUTS: None.
;      RETURNS: Nothing.
...
;               CUR_PP
;
_ReloadConfig_toastedlightuinousb4:
 ReloadConfig_toastedlightuinousb4:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    mov     A, >ReloadConfigTBL_toastedlightuinousb4_Bank0
    mov     X, <ReloadConfigTBL_toastedlightuinousb4_Bank0
    lcall   LoadConfig              ; Reload the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Bank 1 table address:
    mov     A, >ReloadConfigTBL_toastedlightuinousb4_Bank1
    mov     X, <ReloadConfigTBL_toastedlightuinousb4_Bank1
...
;---------------------------------------------------------------------------
; Unload Configuration toastedlightuinousb4
;
;    Reset configuration registers for toastedlightuinousb4
...
;               CUR_PP
;
_UnloadConfig_toastedlightuinousb4:
 UnloadConfig_toastedlightuinousb4:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Bank 0 table address:
    mov     A, >UnloadConfigTBL_toastedlightuinousb4_Bank0
    mov     X, <UnloadConfigTBL_toastedlightuinousb4_Bank0
    lcall   LoadConfig              ; Unload the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Bank 1 table address:
    mov     A, >UnloadConfigTBL_toastedlightuinousb4_Bank1
    mov     X, <UnloadConfigTBL_toastedlightuinousb4_Bank1
...
; clear config active bit
	RAM_SETPAGE_CUR >ACTIVE_CONFIG_STATUS
	and		[ACTIVE_CONFIG_STATUS+toastedlightuinousb4_ADDR_OFF], ~toastedlightuinousb4_BIT
    M8C_SetBank0                    ; Force return to bank 0
	pop		x
