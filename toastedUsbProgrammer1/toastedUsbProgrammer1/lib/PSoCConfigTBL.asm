...
export LoadConfigTBL_toastedUsbProgrammer1_Bank1
export LoadConfigTBL_toastedUsbProgrammer1_Bank0
export LoadConfigTBL_toastedUsbProgrammer1_Ordered
export UnloadConfigTBL_toastedUsbProgrammer1_Bank1
export UnloadConfigTBL_toastedUsbProgrammer1_Bank0
export ReloadConfigTBL_toastedUsbProgrammer1_Bank1
export ReloadConfigTBL_toastedUsbProgrammer1_Bank0
...
;  Instance name SPIS, User Module SPIS
	db		ffh
LoadConfigTBL_toastedUsbProgrammer1_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_toastedUsbProgrammer1_Bank1:
;  Instance name SPIM, User Module SPIM
;  Instance name Timer16, User Module Timer16
;  Instance name USBFS, User Module USBFS
...
LoadConfigTBL_toastedUsbProgrammer1_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 10h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 8ah		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[01h], 00h		; Port_0_IntEn register (PRT0IE)
	mov	reg[04h], 12h		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
	mov	reg[04h], b3h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], 02h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	...
	ret
AREA lit(rom, rel)
ReloadConfigTBL_toastedUsbProgrammer1_Bank0:
;  Instance name SPIM, User Module SPIM
;  Instance name Timer16, User Module Timer16
;  Instance name USBFS, User Module USBFS
	db		ffh
ReloadConfigTBL_toastedUsbProgrammer1_Bank1:
;  Instance name SPIM, User Module SPIM
;  Instance name Timer16, User Module Timer16
;  Instance name USBFS, User Module USBFS
	db		ffh
UnloadConfigTBL_toastedUsbProgrammer1_Bank0:
;  Instance name SPIM, User Module SPIM
;  Instance name Timer16, User Module Timer16
;  Instance name USBFS, User Module USBFS
	db		ffh
UnloadConfigTBL_toastedUsbProgrammer1_Bank1:
;  Instance name SPIM, User Module SPIM
;  Instance name Timer16, User Module Timer16
;  Instance name USBFS, User Module USBFS
	db		ffh
