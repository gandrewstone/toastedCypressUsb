...
export  Timer16_SetMode
export _Timer16_SetMode
export  Timer16_SetPeriod
export _Timer16_SetPeriod


AREA toastedUsbProgrammer1_RAM (RAM,REL)
...
_Timer16_EnableInt:
   ...
   M8C_EnableIntMask    Timer16_INT_REG, Timer16_INT_MASK ; Enable the interrupt
...
_Timer16_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask    Timer16_INT_REG, Timer16_INT_MASK ; Disable the interrupt
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_Timer16_Start:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or reg[Timer16_CONFIG_REG], PT_CFG_START  ; Set the Start bit
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_Timer16_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and reg[Timer16_CONFIG_REG], ~PT_CFG_START ; Clear the Start bit
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_Timer16_SetMode:
   ...
   jz .Continuous
   or reg[Timer16_CONFIG_REG], PT_CFG_One_Shot ; Set the Mode bit in the PT_CFG register
   jmp .exit  
.Continuous:
   and reg[Timer16_CONFIG_REG], ~PT_CFG_One_Shot  ; Set the Mode bit in the PT_CFG register
.exit:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_SetPeriod
;
;  DESCRIPTION:
...
_Timer16_SetPeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
    mov     REG[Timer16_DATA0_REG], A  ; Set the reload LSB first
    swap    A, X                       ; Get the MSB
    mov     REG[Timer16_DATA1_REG], A  ; Set the reload MSB
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
