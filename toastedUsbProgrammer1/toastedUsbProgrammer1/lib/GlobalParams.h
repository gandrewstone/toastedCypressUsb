...
#define PORT_0_DRIVE_1         0x8a    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_INTENABLE       0x0     //Port 0 interrupt enable register (PRT0IE)

#define PORT_1_DRIVE_0         0xb3    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0x2     //Port 1 drive mode 1 register (PRT1DM1)
