...
_USBFS_InterfaceSetting:                BLK   2h    ; Interface Setting
;----------------------------------------------------------------------------
...
_USBFS_EP0_ISR:
 ...
 ;   mov  [USBFS_TempMode], USB_MODE_NAK_IN_OUT
 ;   mov  reg[USBFS_EP0MODE], USB_MODE_NAK_IN_OUT
...
USBFS_EP0_UPD_MODE_EXIT:
    ...
    mov     reg[USBFS_EP0CNT], A       ; Update the count
    mov     A, X                       ; Get the new mode
    mov     reg[USBFS_EP0MODE], A      ; Update the node
